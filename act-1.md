...
2.  Click on the Create a design button on the top right of the screen.  <img src="images/02.png" alt="new slide" style="float:right;margin-left:10px;">
    ...
    - This will bring up the Custom Size options. Click on the little drop down for units (default is “px” for pixels) and change it to “in” for inches.  <img src="images/03.png" alt="new slide" style="float:right;width:75;margin-left:10px;">
...
3. Choose a template: <img src="images/04.png" alt="new slide" style="float:right;width:75;margin-left:10px;">
